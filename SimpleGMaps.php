...
function Render_SimpleGMaps_Index() {
	...
	?>
       ...
       <p>
           Valores posibles tipomapa: "SATELLITE", "HYBRID", "TERRAIN" y "ROADMAP" (cambia la vista de nuestro mapa).
       </p>
        <?php
}
...
function simplegmaps_shortcode($atts = array()) {
		...
		//wp_enqueue_script('googleMapsV3', 'https://maps.googleapis.com/maps/api/js?sensor=false');
...
//Agregamos a la cabecera nuestro código javascript de Google maps
add_action('wp_head','simplegmaps_javascript');
function simplegmaps_javascript()
{
